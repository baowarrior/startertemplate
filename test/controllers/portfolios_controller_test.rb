...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { content: @portfolio.content, item_description: @portfolio.item_description, item_name: @portfolio.item_name } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { content: @portfolio.content, item_description: @portfolio.item_description, item_name: @portfolio.item_name } }
